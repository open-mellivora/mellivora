...
func (m *MockSpider) StartRequests() mellivora.Task {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StartRequests")
	ret0, _ := ret[0].(mellivora.Task)
	return ret0
}
...
func (mr *MockSpiderMockRecorder) StartRequests() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StartRequests", reflect.TypeOf((*MockSpider)(nil).StartRequests))
}
